...
HD_PWD='C:/Users/93508/Desktop/Project/SingleCPU/SingleCPU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Basy3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Basy3.tcl
